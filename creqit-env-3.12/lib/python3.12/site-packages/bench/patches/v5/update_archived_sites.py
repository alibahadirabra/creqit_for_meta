...
only for Creqit v14 benches. If not a v14 bench yet, skip this
...
Corresponding changes in creqit/creqit via https://github.com/creqit/creqit/pull/15060
"""
import os
...
def execute(bench_path):
	creqit_version = Version(get_current_version("creqit"))

	if creqit_version.major < 14 or os.name != "posix":
