...
@click.group(help="Setup command group for enabling setting up a Creqit environment")
def setup():
	pass
...
@click.command("fonts", help="Add Creqit fonts to system")
def setup_fonts():
...
@click.command(
	"production", help="Setup Creqit production environment for specific user"
)
@click.argument("user")
