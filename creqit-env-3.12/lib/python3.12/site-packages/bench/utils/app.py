...
def is_version_upgrade(app="creqit", bench_path=".", branch=None):
...
def get_current_creqit_version(bench_path="."):
	try:
		return get_major_version(get_current_version("creqit", bench_path=bench_path))
	except OSError:
		return 0
